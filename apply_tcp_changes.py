#!/usr/bin/env python3
"""Apply all 6 TCP protocol changes to src/tcp/mod.rs in one shot."""
import re
...
# 1. Add to name(): after GenericConnect
...
# 2. Add to port(): after GenericConnect => 80
content = content.replace(
...
# 3. Add to from_str(): after tcp-connect | generic
content = content.replace(
...
# 4. Add dispatch arms: after GenericConnect => generic_connect
content = content.replace(
...
# 5. Append 6 new protocol implementations
new_impls = r'''
// ================================================================
